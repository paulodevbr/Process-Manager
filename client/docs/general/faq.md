...
This simply means that there's another legalProcess already listening on port 3000.
The fix is to kill the legalProcess and rerun `npm start`.

### OS X / Linux:

1.  Find the legalProcess id (PID):
