/*
 *
 * ProcessPage constants
 *
 */

export const CHANGE_TITLE = 'process-manager/process-page/CHANGE_TITLE';
export const CHANGE_DESCRIPTION = 'process-manager/process-page/CHANGE_DESCRIPTION';
